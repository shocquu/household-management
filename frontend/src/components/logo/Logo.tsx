...
const Logo = forwardRef(({ disabledLink = false, sx, ...other }: LogoProps, ref) => {
    ...
    const logo = (
        <Box
            ...
            {...other}>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1160 262'>
                <path
                    fill={TEXT}
                    ...
                    transform='translate(250 31.3)'
                />
                <path d='M13.1 17.4h239.2v239.2H13.1z' fill={PRIMARY_LIGHT} />
                <path d='M25.1 5.5h239.2v239.2H25.1z' fill={PRIMARY_MAIN} />
                <g fill={PRIMARY_MAIN}>
                    <path
